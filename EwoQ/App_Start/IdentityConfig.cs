...
namespace EwoQ
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private async Task configSendGrindAsync(IdentityMessage message, string mail, string nombre)
        {
            ...
            var subject = "Usuario registrado con exito!";
            var to = new EmailAddress(mail, nombre);
            var plainTextContent = "Te has registrado correctamente en el sistema de reportes de incidentes";
            var htmlContent = "<strong>Por este mismo medio se le informa cuando su cuenta haya sido aprobada</strong>";
            var msg = MailHelper.CreateSingleEmail(from, to, subject, plainTextContent, htmlContent);
            var response = await client.SendEmailAsync(msg);

            System.Diagnostics.Debug.WriteLine("Respuesta de correo electrónico "+response.Body);

            //CREAR NUEVO TRANSPORTE PARA ENVIAR MAIL
