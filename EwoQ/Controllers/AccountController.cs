...
namespace EwoQ.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            //    RoleMan.Create(new IdentityRole() {Name = "Super" });
            //}
        ...
        public List<SelectListItem> GetRoles()
        {
            using (ApplicationDbContext db = new ApplicationDbContext())
            {
                ...
                var roles = RoleMan.Roles.Where(x => !x.Name.Equals("Super")).ToList();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //        {
                //            Trace.TraceInformation("Property Ton: {0} Error: {1}", validationError.PropertyName, validationError.ErrorMessage);
                //        }
                //    }
                //}
            }
